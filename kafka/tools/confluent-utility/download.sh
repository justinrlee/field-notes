...
curl -LO https://releases.hashicorp.com/vault/1.20.1/vault_1.20.1_linux_amd64.zip
curl -LO https://releases.hashicorp.com/vault/1.20.1/vault_1.20.1_linux_arm64.zip