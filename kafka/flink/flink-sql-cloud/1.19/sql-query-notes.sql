...
CREATE TABLE `shoe_products` (
    ...
    'properties.sasl.jaas.config' = 'org.apache.kafka.common.security.plain.PlainLoginModule required username="3N3NJE7FFBQ4ZZTW" password="YG9Tkkw76lXKnX9vgBLKXd1oQnISX82BpuUONgbybga56N41U/CmeWOLhA37m6Wy";',
    ...
    'value.avro-confluent.basic-auth.user-info' = 'UWLLPTEJU5AWA24T:hUM1YQzOuBWIdmKGlmgZiNGIOlC3v5chBpNz3WUfPVYagqOtx+nDLVuZU5gaF7jH',
...
CREATE TABLE `shoe_customers_keyed` (
    ...
    'key.avro-confluent.basic-auth.user-info' = 'UWLLPTEJU5AWA24T:hUM1YQzOuBWIdmKGlmgZiNGIOlC3v5chBpNz3WUfPVYagqOtx+nDLVuZU5gaF7jH',
