...
sqlplus sys/confluent123@//${ORACLE_HOSTNAME}:1521/ORCLCDB as sysdba @scripts/validate.sql c##cflt_xstream_capture c##cflt_xstream_client xout ORCLPDB1
# Capture user: c##cflt_xstream_capture
# Connect database user: c##cflt_xstream_client
# Outbound server name: xout
# PDB: ORCLPDB1
