...
CREATE TABLE locations
  (
    location_id NUMBER(10,0) GENERATED BY DEFAULT AS IDENTITY START WITH 24 
                PRIMARY KEY       ,
...
CREATE TABLE order_items
  (
    ...
    item_id    NUMBER( 12, 0 )                                ,
    product_id NUMBER( 19, 0 ) NOT NULL                       , -- fk
