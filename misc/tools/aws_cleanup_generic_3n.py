...
if __name__ == "__main__":
    ...
    NOTIFY_MESSAGES = {
        Result.ADD_ACTION_DATE: "ADD_ACTION_DATE: Added {action} date (tag [{tag}]) of {new_date} to {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region}",
        Result.RESET_ACTION_DATE: "RESET_ACTION_DATE: Updated tag [{tag}] on {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region}: {action} date changed from {old_date} to {new_date}",
        ...
        Result.TRANSITION_ACTION: "TRANSITION_ACTION: Added new {action} on {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region} (tag [{tag}]) on {new_date}",
        Result.PAST_BUMP_NOTIFICATION_1: "PAST_BUMP_NOTIFICATION_1: Updated tag [{tag}] because missing first notification: will {action} {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region} on {new_date} (previously set to {old_date})",
        Result.PAST_BUMP_NOTIFICATION_2: "PAST_BUMP_NOTIFICATION_2: Updated tag [{tag}] because missing second notification: will {action} {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region} on {new_date} (previously set to {old_date}",
        Result.PAST_BUMP_NOTIFICATION_3: "PAST_BUMP_NOTIFICATION_3: Updated tag [{tag}] because missing third notification: will {action} {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region} on {new_date} (previously set to {old_date}",
        Result.SEND_NOTIFICATION_1: "SEND_NOTIFICATION_1: Sending first {action} notification for {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region}: will {action} on {new_date}",
        Result.SEND_NOTIFICATION_2: "SEND_NOTIFICATION_2: Sending second {action} notification for {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region}: will {action} on {new_date}",
        Result.SEND_NOTIFICATION_3: "SEND_NOTIFICATION_3: Sending third {action} notification for {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region}: will {action} on {new_date}",
        Result.LOG_NO_NOTIFICATION: "LOG_NO_NOTIFICATION: Will {action} {state} {instance_type} instance '{instance_name}' [{instance_id}] in region {region} on {new_date}",
